...
Make sure your R version and system compilers are configured so that the package (and its C++/Rcpp components) install successfully.
...
You will use this environment when running `VNNGP.py` (both simulations and real-data analysis).
...
You will use this environment when running `DKLGP.py` and `DKLGP_default.py`.
